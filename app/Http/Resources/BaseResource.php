...
class BaseResource extends JsonResource
{
    ...
    public static function collectionBody($resource)
    {
        $res = new AnonymousResourceCollection($resource, get_called_class());
    ...
    )
    {
        ...
        $errorsArray = $errors ? $errors : $errorMeta;
    ...
    public static function exception($e)
    {
        ...
        return static::returns($e->getMessage(), 500);
    }
    ...
    public static function returns($message = 'error!', $statusCode = 400, $status = false)
    {
        return response()->json(
            [
